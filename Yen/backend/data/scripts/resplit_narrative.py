...
FOLDER_META = {
    "khoa_phong": {"doc_id": "khoa_phong", "source_doc": "website chính thức của bệnh viện",
                   "category": "to_chuc_khoa_phong", "approved_by": ""},
    "lich_su_phat_trien": {"doc_id": "lich_su_phat_trien", "source_doc": "website chính thức của bệnh viện",
    ...
    "dich_vu": {"doc_id": "dich_vu", "source_doc": "website chính thức của bệnh viện",
                "category": "dich_vu_y_te", "approved_by": ""},
    "bookingcare_gioi_thieu": {"doc_id": "bookingcare_gioi_thieu", "source_doc": "bookingcare.vn",
                               "category": "gioi_thieu_benh_vien", "approved_by": ""},
    "quy_trinh": {"doc_id": "quy_trinh", "source_doc": "Quy trình QT.25.01 - bệnh viện",
